...
namespace EditorGrafos
{
    public class Nodo
    {
        ...
        public void añadeRelacion(Arista arista)
        {
            LRel.Add(arista.GSDestino);
        }

        public void añadeRelacion(Nodo Destino, int peso, bool diri)
        {
            LRel.Add(Destino);
        }
